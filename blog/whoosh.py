...
class _QueryProxy(Query):
    ...
    def __iter__(self):
        ...
        for row in super_iter:
            ...
            heapq.heappush(ordered_by_whoosh_rank, (self._whoosh_rank[unicode(
    ...
    async def whoosh_search(self, query, limit=None, fields=None, or_=False):
        '''
        ...
        if not results:
            ...
            return await self.filter(sqlalchemy.text('null'))
